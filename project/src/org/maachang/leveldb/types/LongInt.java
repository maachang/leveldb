...
/**
 * Number64(long)、Number32(int)の２キー情報.
 */
public final class LongInt extends TwoKey {
	 ...
	 *            2つ目のキーを設定します.
	 */
	public LongInt(Object one, Object two) {
		this.set(one, two);
	}
	 ...
	 *                例外.
	 */
	public LongInt(JniBuffer buf) throws Exception {
		create(buf);
	}
	 ...
	 * @exception Exception.
	 */
	public LongInt(JniBuffer buf, int off, int len) throws Exception {
		create(buf, off, len);
	}
	...
	public static final void convertBuffer(Object one, Object two, JniBuffer buf) throws Exception {
		...
		// two.
		JniIO.putInt(addr, pos + 8, (Integer) two);
		buf.addPosition(12);
	}
	...
	public final String toString() {
		return new StringBuilder("[num64-num32]").append(one).append(",").append(two).toString();
	}
}
