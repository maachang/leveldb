...
/**
 * Number64(long)、Number64(long)の２キー情報.
 */
public final class LongLong extends TwoKey {
	 ...
	 *            2つ目のキーを設定します.
	 */
	public LongLong(Object one, Object two) {
		this.set(one, two);
	}
	 ...
	 *                例外.
	 */
	public LongLong(JniBuffer buf) throws Exception {
		create(buf);
	}
	 ...
	 * @exception Exception.
	 */
	public LongLong(JniBuffer buf, int off, int len) throws Exception {
		create(buf, off, len);
	}
	...
	public final String toString() {
		return new StringBuilder("[num64-num64]").append(one).append(",")
				.append(two).toString();
	}
