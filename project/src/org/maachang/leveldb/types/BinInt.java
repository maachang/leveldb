...
/**
 * バイナリ、Number32(int)の２キー情報.
 */
public final class BinInt extends TwoKey {
	 ...
	 *            2つ目のキーを設定します.
	 */
	public BinInt(Object one, Object two) {
		this.set(one, two);
	}
	 ...
	 *                例外.
	 */
	public BinInt(JniBuffer buf) throws Exception {
		create(buf);
	}
	 ...
	 * @exception Exception.
	 */
	public BinInt(JniBuffer buf, int off, int len) throws Exception {
		create(buf, off, len);
	}
	...
	public final int compareTo(Object o) {
		...
		if (o instanceof BinInt) {
			TwoKey t = (TwoKey) o;
			int ret = Utils.binaryCompareTo(one, (byte[]) one());
			if (ret == 0) {
	...
	public final String toString() {
		return new StringBuilder("[bin-num32]").append(
