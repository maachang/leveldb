...
/**
 * 文字列、Number64(long)の２キー情報.
 */
public final class StrLong extends TwoKey {
	 ...
	 *            2つ目のキーを設定します.
	 */
	public StrLong(Object one, Object two) {
		this.set(one, two);
	}
	 ...
	 *                例外.
	 */
	public StrLong(JniBuffer buf) throws Exception {
		create(buf);
	}
	 ...
	 * @exception Exception.
	 */
	public StrLong(JniBuffer buf, int off, int len) throws Exception {
		create(buf, off, len);
	}
	...
	public final int toBufferLength() {
		return JniIO.utf16Length(one) + 10;
	}
	...
	public final String toString() {
		return new StringBuilder("[str-num64]").append(one).append(",").append(two).toString();
	}
