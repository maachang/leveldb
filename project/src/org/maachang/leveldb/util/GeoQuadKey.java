 ...
 * ただし、本来のQuadKeyは文字なのだが、このQuadKeyは、2ビット単位で情報を
 * 保持しており、数値で扱えるので、文字列での検索と比べて、高速に検索が可能.
 */
public final class GeoQuadKey {
	protected GeoQuadKey() {}
	...
	/**
	 * QuadKeyの終端キーを取得. また、[quadKey]でキーを作成した場合、detailを23(最大値)で生成した場合は、
	 * この条件に意味を持ちません.
	 * 
	 * @param detail
	 *            拡大率を設定します. この値は[1]～[23]の範囲で設定します.
	 * @param key
	 *            [quadKey]で生成したキーを設定します.
	 */
	 ...
	 * 
	 * @param out
	 *            範囲検索用QueadKeyを格納する条件を設定します. [n]最小値. [n+1]最大値 ...
	 ...
	 * @param lon
	 *            経度を設定します.
	 * @return 範囲検索のQuadKeyが返却されます. [n]最小値. [n+1]最大値 ... 検索範囲のQuadKeyの最小値、最大値
	 *         合計で18個が格納されます.
	 */
